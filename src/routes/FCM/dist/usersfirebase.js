...
var deviceTokenSchema = zod_1.z.object({
 ...
 */
router.post("/device-token", authentication_1.authenticationMiddleware, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var deviceToken, userId, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                deviceToken = deviceTokenSchema.parse(req.body).deviceToken;
