...
exports.apiAuthRoutes = exports.accountsAuthRoutes = void 0;
...
var logout_1 = require("../../controllers/accounts/auth/logout");
dotenv_1["default"].config();
var accountsAuthRoutes = express_1["default"].Router();
exports.accountsAuthRoutes = accountsAuthRoutes;
var apiAuthRoutes = express_1["default"].Router();
exports.apiAuthRoutes = apiAuthRoutes;
/**
 * @openapi
 ...
 *                         type: string
 */
accountsAuthRoutes.post("/register", errorHandler_1.errorHandler(root_1.Register));
/**
 * @openapi
 ...
 */
accountsAuthRoutes.post("/registers", errorHandler_1.errorHandler(root_1.Register));
/**
 * @openapi
 * /accounts/auth/login:
 *   post:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
accountsAuthRoutes.post("/login", authentication_1.loginRateLimiter, errorHandler_1.errorHandler(root_1.Login));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
accountsAuthRoutes.post("/account-verify", errorHandler_1.errorHandler(root_1.AccountVerify));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
accountsAuthRoutes.post("/request-account-verify", errorHandler_1.errorHandler(root_1.RequestAccountVerify));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
accountsAuthRoutes.post("/token/refresh", errorHandler_1.errorHandler(root_1.TokenRefresh));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
accountsAuthRoutes.post("/token/verify", errorHandler_1.errorHandler(root_1.TokenVerify));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ValidationErrorResponse'
 */
accountsAuthRoutes.post("/request-password-reset", errorHandler_1.errorHandler(root_1.RequestPasswordReset));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
accountsAuthRoutes.post("/password-reset", errorHandler_1.errorHandler(root_1.PasswordReset));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ValidationErrorResponse'
 */
accountsAuthRoutes.post("/account-delete-request", authentication_1.authenticationMiddleware, errorHandler_1.errorHandler(root_1.RequestAccountDeletion));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
accountsAuthRoutes.post("/logout", authentication_1.authenticationMiddleware, errorHandler_1.errorHandler(logout_1.logout));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ValidationErrorResponse'
 */
accountsAuthRoutes.post("/verify-account-deletion-otp", authentication_1.authenticationMiddleware, errorHandler_1.errorHandler(root_1.VerifyAccountDeletionOtp));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ValidationErrorResponse'
 */
accountsAuthRoutes.post("/verify-migration-otp", errorHandler_1.errorHandler(root_1.verifyMigrationOTP));
/**
 * @openapi
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
apiAuthRoutes.post("/verify-account", errorHandler_1.errorHandler(root_1.AccountVerify));
