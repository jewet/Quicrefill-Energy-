...
import { smsTemplateController, SMSTemplateController } from "../../controllers/SmSTemplate/smsTemplate";
...
router.post(
  ...
  smsTemplateController.createTemplate.bind(smsTemplateController)
);
...
router.patch(
  "/sms-templates/:id",
  SMSTemplateController.validateTemplate,
  smsTemplateController.updateTemplate.bind(smsTemplateController)
);
...
router.delete(
  "/sms-templates/:id",
  smsTemplateController.deleteTemplate.bind(smsTemplateController)
);
...
router.get(
  "/sms-templates",
  smsTemplateController.getTemplates.bind(smsTemplateController)
);
...
router.get(
  "/sms-templates/:id",
  smsTemplateController.getTemplateById.bind(smsTemplateController)
);
...
router.post(
  ...
  smsTemplateController.sendOtpSMS.bind(smsTemplateController)
);
...
router.post(
  ...
  smsTemplateController.sendBulkSMS.bind(smsTemplateController)
);
